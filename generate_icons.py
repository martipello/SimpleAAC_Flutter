...
def generate_and_save_image(word_obj):
    ...
    style_description = (
        "Strictly standardized minimalist pediatric AAC icon glyph. Purely flat, simple, clean 2D line-art style. "
        "The icon features a uniform, single medium-thick black outline with flat solid white fills on a plain, clean flat white canvas. "
