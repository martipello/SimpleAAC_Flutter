...
/// Supports SSML/IPA for precise phonetic control.
 String? get phoneticOverride; WordType get type; WordSubType get subType;/// Filename only for core vocabulary (e.g. `bowl.png`), resolved to a
/// full Firebase Storage path at display time via [ImagePathService].
/// User-added words store the full path directly.
 String? get imagePath;/// False for user-created words.
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,wordId,text,phoneticOverride,type,subType,imagePath,isCoreVocabulary,isFavourite,const DeepCollectionEquality().hash(extraRelatedWordIds),const DeepCollectionEquality().hash(aiSuggestedFollowUps),const DeepCollectionEquality().hash(localEmbedding),createdDate);

@override
String toString() {
  return 'Word(wordId: $wordId, text: $text, phoneticOverride: $phoneticOverride, type: $type, subType: $subType, imagePath: $imagePath, isCoreVocabulary: $isCoreVocabulary, isFavourite: $isFavourite, extraRelatedWordIds: $extraRelatedWordIds, aiSuggestedFollowUps: $aiSuggestedFollowUps, localEmbedding: $localEmbedding, createdDate: $createdDate)';
}
...
@useResult
$Res call({
 String wordId, String text, String? phoneticOverride, WordType type, WordSubType subType, String? imagePath, bool isCoreVocabulary, bool isFavourite, List<String> extraRelatedWordIds, List<String> aiSuggestedFollowUps, List<double>? localEmbedding, DateTime? createdDate
});
...
/// Create a copy of Word
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? wordId = null,Object? text = null,Object? phoneticOverride = freezed,Object? type = null,Object? subType = null,Object? imagePath = freezed,Object? isCoreVocabulary = null,Object? isFavourite = null,Object? extraRelatedWordIds = null,Object? aiSuggestedFollowUps = null,Object? localEmbedding = freezed,Object? createdDate = freezed,}) {
...
as String?,isCoreVocabulary: null == isCoreVocabulary ? _self.isCoreVocabulary : isCoreVocabulary // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String wordId,  String text,  String? phoneticOverride,  WordType type,  WordSubType subType,  String? imagePath,  bool isCoreVocabulary,  bool isFavourite,  List<String> extraRelatedWordIds,  List<String> aiSuggestedFollowUps,  List<double>? localEmbedding,  DateTime? createdDate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Word() when $default != null:
return $default(_that.wordId,_that.text,_that.phoneticOverride,_that.type,_that.subType,_that.imagePath,_that.isCoreVocabulary,_that.isFavourite,_that.extraRelatedWordIds,_that.aiSuggestedFollowUps,_that.localEmbedding,_that.createdDate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String wordId,  String text,  String? phoneticOverride,  WordType type,  WordSubType subType,  String? imagePath,  bool isCoreVocabulary,  bool isFavourite,  List<String> extraRelatedWordIds,  List<String> aiSuggestedFollowUps,  List<double>? localEmbedding,  DateTime? createdDate)  $default,) {final _that = this;
switch (_that) {
case _Word():
return $default(_that.wordId,_that.text,_that.phoneticOverride,_that.type,_that.subType,_that.imagePath,_that.isCoreVocabulary,_that.isFavourite,_that.extraRelatedWordIds,_that.aiSuggestedFollowUps,_that.localEmbedding,_that.createdDate);}
}
...
class _Word implements Word {
  const _Word({required this.wordId, required this.text, this.phoneticOverride, required this.type, required this.subType, this.imagePath, this.isCoreVocabulary = true, this.isFavourite = false, final  List<String> extraRelatedWordIds = const [], final  List<String> aiSuggestedFollowUps = const [], final  List<double>? localEmbedding, this.createdDate}): _extraRelatedWordIds = extraRelatedWordIds,_aiSuggestedFollowUps = aiSuggestedFollowUps,_localEmbedding = localEmbedding;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,wordId,text,phoneticOverride,type,subType,imagePath,isCoreVocabulary,isFavourite,const DeepCollectionEquality().hash(_extraRelatedWordIds),const DeepCollectionEquality().hash(_aiSuggestedFollowUps),const DeepCollectionEquality().hash(_localEmbedding),createdDate);
...
/// Create a copy of Word
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? wordId = null,Object? text = null,Object? phoneticOverride = freezed,Object? type = null,Object? subType = null,Object? imagePath = freezed,Object? isCoreVocabulary = null,Object? isFavourite = null,Object? extraRelatedWordIds = null,Object? aiSuggestedFollowUps = null,Object? localEmbedding = freezed,Object? createdDate = freezed,}) {
  return _then(_Word(
wordId: null == wordId ? _self.wordId : wordId // ignore: cast_nullable_to_non_nullable
as String,text: null == text ? _self.text : text // ignore: cast_nullable_to_non_nullable
as String,phoneticOverride: freezed == phoneticOverride ? _self.phoneticOverride : phoneticOverride // ignore: cast_nullable_to_non_nullable
