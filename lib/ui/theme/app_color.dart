...
// Create a corresponding custom flex scheme color for a dark theme.
  ...
  static const Color wordTypeNoun = Color(0xFF9FC9FF);
  static const Color wordTypeQuick = Color(0xFF00325B);
  static const Color wordTypeVerb = Color(0xFFFFB59D);
  static const Color wordTypeOther = Color(0xFF872100);
}
