...
class _IndicatorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final from = (ltr ? value.floor() : value.ceil()).clamp(0, maxTabIndex).toInt();
    final to = (ltr ? from + 1 : from - 1).clamp(0, maxTabIndex).toInt();
...
class _TabBarState extends State<TabBar> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_controller!.length == 0) {
      return Container(
        height: kTabHeight + widget.indicatorWeight,
      );
    }
      ...
      builder: (context, child) {
        return Semantics(
          ...
          child: Row(
            ...
            children: List<Widget>.generate(tabController.length, (tabIndex) {
